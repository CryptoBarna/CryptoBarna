# Benvingut / Benvenido / Welcome @ Crypto Barna
...
## ROADMAP
x Strip and import HTML from last iteration of website
x Create Folders for each of the three languages
x Create dedicated README.md for each language
